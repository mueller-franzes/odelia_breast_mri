...
class DUKE_Dataset3D(SimpleDataset3D):
    def __init__(self, path_root, item_pointers=[], crawler_glob='*.nii.gz', transform=None, image_resize=None, flip=False, image_crop=None, norm='min-max_clip', to_tensor=True):
