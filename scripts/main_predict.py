...
import pandas as pd
from odelia.data.datasets import DUKE_Dataset3D, DUKE_Dataset3D_external, DUKE_Dataset3D_collab
from odelia.data.datamodules import DataModule
from odelia.utils.roc_curve import plot_roc_curve, cm2acc, cm2x
import torch
from odelia.models import ResNet, VisionTransformer, EfficientNet, EfficientNet3D, EfficientNet3Db7, UNet3D
...
if __name__ == "__main__":
    ...
    duke_test_path='/mnt/sda1/swarm-learning/radiology-dataset/divided_odelia_dataset/3d-cnn/test'
    predict(
        model_dir = Path(
        '/mnt/sda1/swarm-learning/training_results/2024_04_30_110539_DUKE_internal_ResNet101_sub_malignancy'),
        test_data_dir=duke_test_path,


        #'/opt/hpe/swarm-learning-hpe/workspace/odelia-breast-mri/user/data-and-scratch/data/DUKE_ext/test',
        model_name='ResNet101',
        last_flag=False,
        prediction_flag='internal',
        cohort_flag = 'duke_internal')