...
if __name__ == "__main__":
    ...
    #print(args)
    dir = '/opt/hpe/swarm-learning-hpe/workspace/odelia-breast-mri/user/data-and-scratch/scratch/'
    #get all the folders in the directory
    folders = os.listdir(dir)
    print(folders)
    for scratch in folders:

        args.path_run=dir+scratch
        args.network = args.path_run.split('_')[-3]
        print(args.network)
